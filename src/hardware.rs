//! Sling split helpers and diagram stroke colors.
//!
//! Shackle ratings live in `catalog::shackle`. `split_slings` moves to `layers::split`
//! in a later Step 0 commit; `sling_stroke_color` moves to UI components in 0.5.
